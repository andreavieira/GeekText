...
function addressDropdown() {
  document.getElementById("address-dropdown-content").classList.toggle("show");
}

window.onclick = function(event) {
  if (!event.target.matches('.addressDrop-btn')) {
    var dropdowns = document.getElementsByClassName("address-dropdown-content");
    var i;
    for (i = 0; i < dropdowns.length; i++) {
      var openDropdown = dropdowns[i];
      if (openDropdown.classList.contains('show')) {
...
function saveNewAddress() {
  ...
  var streetAddress = document.getElementById("streetChange").value;
  var city = document.getElementById("cityChange").value;
  var state = document.getElementById("stateChange").value;
  var zipCode = document.getElementById("zipChange").value;
  var country = document.getElementById("countryChange").value;
    ...
    || (state == "") || (zipCode == "") || (country == ""))
  {
    ...
    db.collection('users').doc(userUid).collection('addresses').add({
